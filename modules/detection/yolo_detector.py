...
# Import the new patch system
from .patches import apply_yolov12_patch

# Import processing modules
from .processing import DetectionPipeline, ImageProcessingQueue, BatchProcessor

# Import watch mode components
...
class YOLODetector:
    ...
    def __init__(
        ...
        self.pipeline = DetectionPipeline(detector=self)
    ...
    def batch_process_images(
        ...
        This method delegates to the DetectionPipeline for the complete detection pipeline:
        ...
        """
        return self.pipeline.batch_process_images(
            limit=limit,
    ...
    def get_detection_statistics(self, days: int = 7) -> Dict[str, any]:
        ...
        This method delegates to the DetectionPipeline for comprehensive statistics.
        ...
        """
        return self.pipeline.get_detection_statistics(days=days)

    def clear_detection_cache(self):
        """Clear any cached detection results to free memory."""
        self.pipeline.clear_detection_cache()
